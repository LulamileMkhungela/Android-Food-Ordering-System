...
public class ThankYou extends Activity {
    ...
    public void main_menu(View view)
    {
        ...
        NatedVeg.chicken_burger=0;
        NatedVeg.chicken_bbq_pizza=0;
        NatedVeg.chicken_tikka=0;
        NatedVeg.fried_fish_rice=0;
        NatedVeg.kolhapuri_chicken=0;
        NatedVeg.chicken_noodles=0;
        NatedVeg.chicken_fried_rice=0;
        NatedVeg.chicken_lollipop=0;
        NatedVeg.chicken_biryani=0;
        NatedVeg.mutton_biryani=0;
        NatedVeg.n_veg_total=0;
